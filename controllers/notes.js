...
// when using await/async, error handling middleware called auto
notesRouter.post('/', async (request, response) => {
  const body = request.body

  // check if user has a token by isolating it
  // decoded token contains user id & name
  ...
  // link user to newly created note
  if (!user) {
